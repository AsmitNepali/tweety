    ...
    <div>
        ...
        <div>
            <div class="flex items-center">
                <span class="svg-icon">
                    <svg viewBox="0 0 20 20" class="text-gray-500 mr-1 w-4" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div>
            <div class="flex items-center">
                <span class="svg-icon">
						<svg viewBox="0 0 20 20"  class="w-4 {{ $tweet->isDislikedBy(current_user())? 'text-blue-500' : 'text-gray-500' }}"version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
						<g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							<g class="fill-current">
